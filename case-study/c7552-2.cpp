...
{
    char topName[] = "case7552-2/top.blif";
    char m56Name[] = "case7552/M56-17.p.blif";
    char m8Name[] = "case7552/M8-17.p.blif";
    char M9xName[] = "case7552-2/M9x.n.blif";
    char M9yName[] = "case7552-2/M9y.n.blif";
...
{
    Cmd_CommandAdd(pAbc, "Time-frame Folding", "c7552-2", C7552_Command, 0);
}
