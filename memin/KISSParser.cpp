...
void parseKISSFile(string filename, 
                   vector<vector<pair<IncSpecSeq*,pair<int, IncSpecSeq*> > > >& states,
                   int& resetState, int& numInputBits, int& numOutputBits, 
                   const bool& firstStateReset) 
{
	resetState=-1;
